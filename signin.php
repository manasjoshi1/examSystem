...
<div class="container register">
                <div class="row">
                    <div class="col-md-3 register-left">
                      ...
                      <a href="signup.php"><input type="submit" name="" value="Sign Up"  required/></a>  <brrequired/>
                      <a href="forgot_password.php"><input type="submit" name="" value="Forgot Password?"  required/></a>  <brrequired/>
